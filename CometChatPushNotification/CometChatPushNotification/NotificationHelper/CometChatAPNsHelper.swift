...
class CometChatAPNsHelper {
    ...
    public func registerTokenForPushNotification(deviceToken: Data) {
        ...
        CometChatNotifications.registerPushToken(pushToken: hexString, platform: CometChatNotifications.PushPlatforms.APNS_IOS_DEVICE, providerId: "Enter your APNs provider ID here", onSuccess: { (success) in
    ...
    public func registerForVoIPCalls(pushCredentials: PKPushCredentials) {
        ...
        CometChatNotifications.registerPushToken(pushToken: deviceToken, platform: CometChatNotifications.PushPlatforms.APNS_IOS_VOIP, providerId: "Enter your APNs provider ID here", onSuccess: { (success) in
